...
>
> The OSF filing procedure mechanics (how to upload, what fields OSF asks for) below remain accurate; only the artifact references and pre-flight checklist content are stale. Tracked since [PR #137 F3 deferral](https://github.com/FireDevPro/energy-stack/pull/137); resolved by this doc-sweep.
