...
| Type | Count |
|---|---:|
| Unexpected reason codes | 0 |
| Supervisor non-approved decisions | 0 |
| Stale feeds | 0 |
| Trace-vs-Influx discrepancies | 0 |
| Unexplained price spikes | 0 |
| Query errors | 0 |
...
- **`NORMAL`** (reason: `high_75_to_84`)
  high_f=80.0, apparent_max_f=82.0

  | rule | threshold | actual | fired | reason_code |
  |---|---|---|---|---|
  | high_ge_hot | 85 | 80 | ❌ | `DAY_TYPE_HOT_HIGH_GE_85` |
  | high_ge_normal | 75 | 80 | ✅ | `DAY_TYPE_NORMAL_HIGH_75_TO_84` |
...
|---|---|---|---|---|---|---|---|---|---|
| 13:00:01-05:00 | `tick_aaa` | layer | schedule | 79 | 79 | 79 | 79 |  |  |
| 13:00:01-05:00 | `tick_aaa` | sup |  |  |  |  |  | approved | `SUPERVISOR_APPROVED` |


## §3 Price spike reaction audit — 2026-05-15

No spikes today (no `comed.prices` ≥10¢ on this date).
...
| `haven.indoor` | continuous | 2026-05-16T07:59:00+00:00 | 1m | ✅ fresh |
...
| `DAY_TYPE_NORMAL_HIGH_75_TO_84` | ✅ observed live | 5 | 5 |
...
| Code | Status | Cumulative | Last 7 days |
|---|---|---:|---:|
| `LAYER_RESOLUTION_SCHEDULE_WINS` | ✅ observed live | 200 | 200 |
| `LAYER_RESOLUTION_PRICE_OVERLAY_WINS` | ⚪ not observed live | 0 | 0 |
...
| `PRECOOL_REJECTED_NO_CHEAP_WINDOW` | ✅ observed live | 5 | 5 |
...
| Code | Status | Cumulative | Last 7 days |
|---|---|---:|---:|
| `PRICE_OVERLAY_NORMAL_BELOW_TRIGGER` | ✅ observed live | 50 | 50 |
...
| Code | Status | Cumulative | Last 7 days |
|---|---|---:|---:|
| `SUPERVISOR_APPROVED` | ✅ observed live | 250 | 250 |
| `SUPERVISOR_CLAMPED_COOL_FLOOR` | ⚪ not observed live | 0 | 0 |
